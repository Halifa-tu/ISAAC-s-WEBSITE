...
```
landmark_realty/
├── app.py                  ← Main application (routes, database)
├── landmark.db             ← SQLite database (auto-created on first run)
...
└── templates/
    ├── base.html            ← Public navbar + footer layout
    ├── index.html           ← Home page
    ├── properties.html      ← Listings with filters
    ├── property_detail.html ← Single property page with gallery
    ├── about.html
    ├── services.html
    ├── request.html         ← Property request form
    ├── contact.html
    ├── _property_card.html  ← Reusable card partial
    └── admin/
        ├── base.html        ← Admin sidebar layout
        ├── login.html
        ├── dashboard.html
        ├── listings.html
        ├── listing_form.html ← Add/edit listing + image upload
        ├── requests.html
        ├── messages.html
        └── settings.html
```
